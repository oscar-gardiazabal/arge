...
NyARTransMat = ASKlass('NyARTransMat', INyARTransMat, {// class calculates ARMatrix from square information and holds it
    ...
    transMatContinue: function(i_square, i_offset, o_result_conv) {
        ...
        var rot = this.__rot;
        // Again the error rate is Tara greater amount than the threshold error value of the last
...
NyARRotMatrix = ASKlass('NyARRotMatrix', NyARDoubleMatrix33, {// Of rotation matrix calculation, 3x3 matrix
    ...
    initRotBySquare: function(i_linear, i_sqvertex) {
        ...
        if (aaaa == 100) {
            console.log(i_linear[0].dx + " , " + i_linear[0].dy + " , " + i_linear[0].c);
            console.log(i_linear[1].dx + " , " + i_linear[1].dy + " , " + i_linear[1].c);
            console.log(i_linear[2].dx + " , " + i_linear[2].dy + " , " + i_linear[2].c);
            console.log(i_linear[3].dx + " , " + i_linear[3].dy + " , " + i_linear[3].c);
            aaaa = 0;
        } else {
            aaaa++;
        }
