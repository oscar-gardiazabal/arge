...
Game.model.unit.geometries.low.legs = function(){
    ...
    $(legsImg).load(function() {
        imageLoaded(legLmesh);
        imageLoaded(legRmesh);
    });
    legsImg.src = Game.model.unit.materials.images.legs;

    function imageLoaded(mesh) {
        mesh.material = new THREE.MeshBasicMaterial();
        mesh.material.map = getTexture(legsImg);
